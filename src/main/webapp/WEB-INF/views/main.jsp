	...
	<div class="container">
		<div id="header">
			...
			<div id="header_banner">
				<div class="text">
					<span id="banner_text"
						style="float: left; padding-left: 15px; padding-top: 10px;">업무에
						지친 당신... <br />퇴근 후 여유를 누리세요~
					</span>
				</div>
			</div>
		</div>
		<div class="block">
			<div id="block_top">
				<ul>
					<li><a
						href="${pageContext.request.contextPath}/nail_search.do"> <img
							src="assets/img/beauty.png" alt="사진" width="150" height="150" />
					</a> <span class="text">beauty</span></li>
					<li><a
						href="${pageContext.request.contextPath}/music_select1.do"> <img
							src="assets/img/music.png" alt="사진" width="150" height="150">
					</a> <span class="text">music</span></li>
					<li><a
						href="${pageContext.request.contextPath}/restaurant_search.do">
							<img src="assets/img/restaurant.png" alt="사진" width="150"
							height="150">
					</a> <span class="text">restaurant</span></li>
				</ul>
			</div>
			<div id="block_bottom">
				<ul>
					...
					</a> <span class="text">nearby</span></li>
					<li><a
						href="${pageContext.request.contextPath}/traffic_search.do"> <img
							src="assets/img/bus.png" alt="사진" width="150" height="150">
					</a> <span class="text">transportation</span></li>
					<li><a href="${pageContext.request.contextPath}/mylist.do">
							<img src="assets/img/list.png" alt="사진" width="150" height="150">
					</a> <span class="text">mylist</span></li>
				</ul>
			</div>
		</div>
		<div id="carousel">
			...
			<div id="carousel-example-generic" class="carousel slide"
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="assets/img/slide-1.jpg" class="carousel_img"
							alt="슬라이더(1)">
						<div class="container">
							<div class="carousel-caption">
								<h1>
									지금 당장<br /> 시원한 맥주가 당긴다면?
								</h1>
								<div class="carousel_shop">
									<p>부엉이호프집</p>
									<h6>
										서울특별시 종로구 인사동로 12길 <br />생맥주& 하몽 23,000원
									</h6>
								</div>
							</div>
						</div>
					...
					<!-- 항목 (2) -->
					<div class="item">
						<img src="assets/img/slide-2.jpg" class="carousel_img"
							alt="슬라이더(2)">
						<div class="container">
							<div class="carousel-caption">
								<h1>
									오늘은 왠지<br /> 색다른 음식이 먹고싶어!
								</h1>
								<div class="carousel_shop">
									<p>프랑스가정식</p>
									<h6>
										서울특별시 종로구 낙원로 29길 <br />라따뚜이 29,000원
									</h6>
								</div>
							</div>
						</div>
					...
					<!-- 항목 (3) -->
					<div class="item">
						<img src="assets/img/slide-3.jpg" class="carousel_img"
							alt="슬라이더(3)">
						<div class="container">
							<div class="carousel-caption">
								<h1>
								...
								<div class="carousel_shop">
									<p>아바이순대국</p>
									<h6>
										서울특별시 강남구 테헤란로 12길 <br />순대국 9,000원
									</h6>
								</div>
							</div>
						</div>
